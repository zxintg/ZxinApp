package com.zxin.basemodel.network;
...
public abstract class AbsAPICallback<T> extends Subscriber<T> {
    ...
    public AbsAPICallback(Context context, int tag, boolean isLoadProgress) {
    ...
    public void onError(Throwable e) {
        ...
        if (e instanceof HttpException) {//HTTP错误
            ...
            switch (httpException.code()) {
                ...
                case -1:
                    ToastUtil.getInstance(mContext).showShort(httpException.getMessage());
                    break;
            ...
            onResultError(tag,resultException);
        }
    }
     ...
     * 服务器返回的错误
     */
    protected abstract void onResultError(int tag, ResultException ex);

    protected abstract void onDone(int tag,T t);
