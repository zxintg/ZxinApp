...
public class SystemInfoUtil {
    ...
    public View getCurrentView() {
        FrameLayout contentParent = (FrameLayout) AppManager.getInstance().currentActivity().getWindow().getDecorView().findViewById(android.R.id.content);
    ...
    public String getActivityMetaData(String tagName) {
        ...
        try {
            info = mContext.getPackageManager()
                    .getActivityInfo(AppManager.getInstance().currentActivity().getComponentName(),
    ...
    public Window getWindow() {
        return AppManager.getInstance().currentActivity().getWindow();
    }
