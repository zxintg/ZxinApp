...
public class GlobalUtil {
    ...
    protected static void setLogPath(String logPath){
        mLogPath = logPath;
    }
    ...
    protected static void setAppCache(String cachePath){
    ...
    protected static void setSdPath(String appSDDir) {
        mAppSDDir = appSDDir;
    }
    ...
    protected static void setRecordLog(boolean recordLog) {
