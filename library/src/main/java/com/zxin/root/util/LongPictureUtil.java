...
public class LongPictureUtil {
    ...
    public void getLongViewPicture(ProgressBarDialog mDialog) {
        ...
        ThreadManager.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                view = SystemInfoUtil.getInstance(context).getCurrentView();
                getItemBitmap(view);
                if (isRecyclerView) {
        ...
        niceDialog.setLayoutId(R.layout.popup_sharecontent)
                .setConvertListener(new ViewConvertListener() {
                    ...
                    public void convertView(NiceDialogViewHolder holder, final BaseNiceDialog dialog) {
                        ...
                        recyclerView.setLayoutManager(UiUtils.getInstance(context).getLayoutManager(UiUtils.LayoutManager.VERTICAL));
