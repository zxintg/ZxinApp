...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    public abstract void convertView(NiceDialogViewHolder holder, BaseNiceDialog dialog);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        convertView(NiceDialogViewHolder.create(view), this);
        return view;
    }
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = SystemInfoUtil.getInstance(getContext()).getScreenWidth() - 2 * margin;
            } else if (width == -1) {
    ...
    public BaseNiceDialog show() {
        FragmentTransaction ft = AppManager.getInstance().getFragmentManager().beginTransaction();
        if (this.isAdded()) {
